...
#define T_ESPERA_MS  40 //Dario tiempo de espera
...
void app_main()
{
    ...
    inicializarPulsador();
// Dario: se cra abajo la tarea destello
...
{
    // ---------- Congiguraciones ------------------------------ //Dario: mi tarea cinfigura mi pin de salida
    gpio_pad_select_gpio(SALIDA1);
    gpio_set_direction(SALIDA1, GPIO_MODE_OUTPUT);

    TickType_t dif; //Darío Tengo una varianle de diferencia
