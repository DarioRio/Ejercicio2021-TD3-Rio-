...
/*==================[Variables]==============================*/
gpio_int_type_t pulsadorPines[1] = { GPIO_NUM_18 }; //Dario: genero un arreglo de un solo elemnto porque tengo un solo pulsador

pulsadorInfo pulsadorA; //Dario: esta es mi estructura que esta en pulsador.h
...
{
    pulsadorA.tecla             = pulsadorPines[0];         //Trabajo con la estructura que esta en el .h
    ...
    gpio_pad_select_gpio(SALIDA_PRUEBA);                //replica lo que hace el pulsador // asi lo veo en la grafica del analizador
