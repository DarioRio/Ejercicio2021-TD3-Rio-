...
#define T_PERIODO_MS  1000
#define T_PERIODO     pdMS_TO_TICKS(T_PERIODO_MS)
...
void tareaDestello( void* taskParmPtr )
{
    ...
    while( true )
    {
        dif = obtenerDiferencia();
            ...
            vTaskDelay( T_PERIODO - dif ); // con este delay me aseguro que el periodo sea de 1 segundo incluyendo el tiempo de trabajo
